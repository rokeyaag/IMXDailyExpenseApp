...
export default function ProfileScreen({ navigation }) {
  ...
  const handleUpdate = async () => {
    setLoading(true);
    try {
      await api.put("/api/auth/profile/", { name, currency });
...
const styles = StyleSheet.create({
  ...
  avatarBox:           { alignItems: "center", paddingTop: 50, paddingBottom: 30 },
  ...
  currencyBtn:         { flex: 1, padding: 12, borderRadius: 12, borderWidth: 1, borderColor: "#e5e7eb", alignItems: "center" },
  currencyBtnActive:   { backgroundColor: "#6366F1", borderColor: "#6366F1" },
  currencyText:        { fontSize: 14, color: "#6b7280", fontWeight: "500" },
