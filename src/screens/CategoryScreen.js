          ...
          <View style={styles.iconGrid}>
            {ICONS.map((item) => (
              <TouchableOpacity
                ...
                <Text style={[styles.iconLabel, selectedIcon === item.emoji && { color: "#fff" }]}>{item.label}</Text>
              </TouchableOpacity>
            ))}
          </View>
...
const styles = StyleSheet.create({
  ...
  iconBtn:          { flexDirection: "row", alignItems: "center", gap: 4, paddingHorizontal: 10, paddingVertical: 8, borderRadius: 10, backgroundColor: "#f3f4f6", borderWidth: 1, borderColor: "#e5e7eb" },
  iconEmoji:        { fontSize: 16 },
  iconLabel:        { fontSize: 11, color: "#374151", fontWeight: "500" },
